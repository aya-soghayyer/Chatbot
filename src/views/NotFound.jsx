...
function NotFound() {
  return (
    <>
      <div className="bg-primary items-center h-screen md:flex md:justify-center md:items-center 2xl:h-screen 2xl:flex 2xl:justify-center 2xl:items-center relative">
        <div className="absolute right-3 -top-12 md:-mt-28 md:right-[63rem] 2xl:-left-64 2xl:-top-24">
          <Circle className="bg-red-500" />
        </div>
        <div className="2xl:flex 2xl:justify-center md:my-7 md:flex md:justify-center md:w-11/12 2xl:w-11/12 2xl:-mt-16 z-10 relative">
          <NotFoundHeader />
        </div>
