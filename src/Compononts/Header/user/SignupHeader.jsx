          ...
          <div className="w-full 2md:w-[40%] -ml-20">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid justify-items-start gap-2 px-5 py-6">
                ...
                <input
                  type="text"
                  id="studentId"
                  className={`border p-4 h-4 w-full  bg-slate-500 border-white rounded-sm ${
                    isInvalid ? "invalid:border-red-500 " : "border-white "
                  }`}
            ...
            {showHelp && (
              <>
                ...
                <div className="brightness-110 absolute top-0 left-0 w-full bg-black/85 z-20 p-5 flex flex-col justify-center items-center h-screen">
